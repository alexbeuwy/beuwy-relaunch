...
Monaten. → Sie liefern zwei Termine und Ihre Fotos. → In sechs Wochen läuft
...
- Beleg-Screenshot für „9 zusätzliche Mandate in den ersten 3 Monaten" (Alex liefert).
...
- scene: Zähler 0 → 9. „zusätzliche Mandate in den ersten 3 Monaten". Quelle klein: RIEGEL Immobilien.
- duration: 8s
- transition_in: cut
- status: built
- voiceover: "Das Ergebnis: neun zusätzliche Mandate in den ersten drei Monaten."
- src: compositions/13-ergebnis.html

Wahr: Aussage Alex 23.09, Beleg folgt. Ohne Beleg kein Render.
