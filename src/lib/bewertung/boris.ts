/**
 * Portiert 1:1 aus dem Riegel-Projekt (src/lib/boris.ts) — reiner
 * Fachcode ohne Riegel-spezifische Abhängigkeiten (keine Imports), daher
 * unverändert übernommen. Fachliche Doku unten ist die Original-Doku.
 *
