...
export const DEFAULTS: Record<string, string> = {
  ...
  "mk.vsl.system_ton": "Mit Ton ansehen",
  "mk.vsl.system_pause": "Film pausieren",
  "mk.vsl.system_weiter": "Weiter ansehen",
...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "mk.vsl.system_url": "/system · Film-URL (mp4, 16:9)",
  "mk.vsl.system_poster": "/system · Film-Vorschaubild (URL)",
  "mk.vsl.system_ton": "/system · Film · Hinweis stumme Vorschau (Klick = Start mit Ton)",
  "mk.vsl.system_pause": "/system · Film · Knopf-Beschriftung Pause (Screenreader)",
  "mk.vsl.system_weiter": "/system · Film · Hinweis nach Pause",
