 ...
 * "im Zweifel Foto".
 *
 * R11 (14.09): jeder Seitentext läuft über Studio-Keys
 * s.marketing-immobilienvertrieb.* (src/lib/texte/seiten/). Die
 * mk.stats.s3_*-Keys (Studio-Zahl in der Floating Card) bleiben wie
 * gehabt aus content.ts.
 */

export const revalidate = 60;

export async function generateMetadata(): Promise<Metadata> {
  const t = seitenTexte(await getContent(), "marketing-immobilienvertrieb");
  return {
    title: t("meta.titel"),
...
export default async function MarketingImmobilienvertriebPage() {
  ...
  const t = seitenTexte(c, "marketing-immobilienvertrieb");
