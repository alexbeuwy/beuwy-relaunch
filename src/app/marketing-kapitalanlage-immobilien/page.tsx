 ...
 * Texte laufen über s.marketing-kapitalanlage-immobilien.* (seitenTexte).
 */

export const revalidate = 60;

export async function generateMetadata(): Promise<Metadata> {
  const t = seitenTexte(await getContent(), "marketing-kapitalanlage-immobilien");
  return {
    title: t("meta.titel"),
...
export default async function MarketingKapitalanlageImmobilienPage() {
  ...
  const t = seitenTexte(c, "marketing-kapitalanlage-immobilien");
  ...
  const actaFakten = t.liste("acta_fakten", ["wert", "label"] as const);
    ...
    <>
      ...
      <section id="beweis" className="bg-bg-base">
        <div className="mx-auto max-w-[1120px] px-6 py-20 md:py-28 lg:px-10">
          ...
          <Reveal delay={60}>
            <div className="mt-14 grid gap-10 border-t border-line-subtle pt-10 lg:grid-cols-[1fr,1.15fr] lg:gap-16">
              <div className="flex flex-col justify-center">
                ...
                <p className="t-body mt-5 max-w-[42ch]">{t("beweis.acta_text")}</p>
              </div>
          ...
          <Reveal delay={100}>
            <p className="t-label mt-16">{t("beweis.zweite_label")}</p>
            <p className="t-h3 mt-3 max-w-[46ch]">{t("beweis.zweite_text")}</p>
          </Reveal>
          {visionGroup ? (
            <div className="mt-10">
